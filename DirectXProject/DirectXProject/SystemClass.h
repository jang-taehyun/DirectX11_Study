...
private:
	...
	void InitializeWindows(int&, int&);		// 윈도우 등록 및 생성, 렌더링 화면 설정, 윈도우 표시
...
public:
	...
	LRESULT CALLBACK MessageHandler(HWND, UINT, WPARAM, LPARAM);		// 윈도우 메세지 및 Application 작업 메세지 처리
};


/* 윈도우 프로시저 */
static LRESULT CALLBACK WndProc(HWND, UINT, WPARAM, LPARAM);			// 윈도우 메세지 처리
